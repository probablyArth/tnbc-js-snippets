...
async function send_tnbc(bankIP, signingKey, destinationAccountNumber, Amount, Memo) {
    ...
    const balance_lock = await getBalanceLock(recipientData.validator.ip, keyPair)
